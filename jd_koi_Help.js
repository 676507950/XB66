...
[task_local]
#锦鲤红包互助
5 0,20 * * * https://raw.githubusercontent.com/KingRan/JDJB/main/jd_koi_Help.js, tag=锦鲤红包互助, enabled=true
================Loon==============
[Script]
cron "5 0,20 * * *" script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_koi_Help.js, tag=锦鲤红包互助
===============Surge=================
锦鲤红包互助 = type=cron,cronexp="5 0,20 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_koi_Help.js
============小火箭=========
锦鲤红包互助 = type=cron,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_koi_Help.js, cronexpr="5 0,20 * * *", timeout=3600, enable=true
TY二次修改 满了删除助力码
给作者助力一次
*/
...
async function help(){
    let res = await getAuthorShareCode('384042166&383066412&383094084&383048810')
    if (!res) {
      $.http.get({url: ''}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
      await $.wait(1000)
      res = await getAuthorShareCode('384042166&383066412&383094084&383048810')
    }
